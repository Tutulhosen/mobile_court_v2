       ...
       <table class="table  table-bordered table-striped table-info mb30" id="prosecutionList">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @else
                        <td>
                        <a href="{{ url('prosecution/newProsecutionWithoutCriminal/' . $row->id . '?prosecution_id=' . $row->id . '&magistrateid=' . $row->magistrateid . '&step=2') }}" class="btn btn-mideum btn-danger">
                        পরিবর্তন
                        </a>
                        </td>
                    @endif
