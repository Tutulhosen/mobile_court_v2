        ...
        <div class="col-lg-12">
            <div class="card card-custom">
                ...
                <div class="card-body  cpv">
                    ...
                    <li id="tab-1"><a href="#tab1-2" data-toggle="tab"><strong>ধাপ ২:</strong> সাক্ষী সংক্রান্ত তথ্য</a></li>
                    <li id="tab-3"><a href="#tab3-2" data-toggle="tab"><strong>ধাপ ৩:</strong> অপরাধ সংক্রান্ত তথ্য</a></li>
                    </ul>
