...
{#<div align="right">#}
    {#{{ link_to("magistrate/create", "<i class='icon-plus-sign'></i> Create Magistrate", "class": "btn btn-primary") }}#}
{#</div>#}
                        ...
                        <td>
                            <table class="text" border="0" cellpadding="4" cellspacing="3" width="100%">
                                <tr >
                                    ...
                                    {#<td align="left" bgcolor="#E0F0E8"><label for="email">E-Mail</label></td>#}
                                    ...
                                    {#<td align="left" bgcolor="#E0F0E8"><label for="phone">phone</label></td>#}
