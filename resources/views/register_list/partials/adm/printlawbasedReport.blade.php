...
<div id="printlawbasedReport" class="content_form">
    <div class="form_top_title" style="margin-left: 5px">
        <table style="width: 100%;text-align: center">
            ...
            <tr style="width: 50%;text-align: center">
                <td style="width: 10px " align="left">অফিসঃ জেলা প্রশাসকের কার্যালয়,<span id="plbreg_officename" align="left">ppreg_officename</span> &nbsp; । &nbsp;</td>
            </tr>
            <tr style="width: 50%;text-align: center">
    ...
    <table id='lawbasedregister_info_adm'  border="1" style="border-collapse:collapse;" cellpadding="2px" cellspacing="2px" width="100%">
...
<script>
    function plbreg_setParams(data){
        ...
        var myTable = document.getElementById("lawbasedregister_info_adm");
...
//          alert(JSON.stringify(element));
            ...
            if(law_id == lawid1){
                $('#lawbasedregister_info_adm').append(
                        '<tr>' +
