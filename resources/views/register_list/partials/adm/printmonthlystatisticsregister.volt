...
<div id="printmonthlystatisticsregister" class="content_form">
    <div class="form_top_title" style="margin-left: 5px">
        <table style="width: 100%">
            <tr>
                <td colspan="4"><h3 class="form_top_title">  <span id="pmcr_name">pmcr_name</span></h3></td>
            </tr>
            <tr style="width: 50%;text-align: center">
                <td style="width: 10px " align="left">অফিসঃ জেলা প্রশাসকের কার্যালয়,<span id="pmcr_officename" align="pmcr_officename">ppreg_officename</span> &nbsp; । &nbsp;</td>
            </tr>
            <tr style="width: 50%;text-align: center">
                <td style="width: 10px " align="left">মামলার তারিখঃ <span id="adm_pmcr_startdate" align="left">startdate</span> <span id="adm_pmcr_enddate" align="left">enddate</span></td>
            </tr>
        </table>
    </div>
    <table id='monthlyReg_info_adm'  border="1" style="border-collapse:collapse;" cellpadding="2px" cellspacing="2px" width="100%">
...
<script>
    function pmcr_setParams(data){
        ...
        document.getElementById("pmcr_name").innerHTML= data.name;
        document.getElementById("pmcr_officename").innerHTML= data.zilla_name;

        var start_date = $('#start_date').val() ;
        var end_date = $('#end_date').val() ;

        document.getElementById("adm_pmcr_startdate").innerHTML= start_date;

        if(end_date !=''){
            document.getElementById("adm_pmcr_enddate").innerHTML= "&nbsp; হতে &nbsp; " + end_date;
        }else{
            document.getElementById("adm_pmcr_enddate").innerHTML= "&nbsp; হতে &nbsp; " + gettodaydate();
        }



        var myTable = document.getElementById("monthlyReg_info_adm");
