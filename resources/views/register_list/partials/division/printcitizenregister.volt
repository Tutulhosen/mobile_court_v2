...
<div id="printcitizenregister" class="content_form">
    <div class="form_top_title" style="margin-left: 2px">
        <table class="fixed" style="width:100% ;text-align: center">
            ...
            <tr>
                <td align="left">অভিযোগের তারিখঃ <span id="dm_pcr_startdate" align="left">startdate</span> <span
                            id="dm_pcr_enddate" align="left">enddate</span></td>
            </tr>
        </table>
    </div>
    <table id='complain_info_dm' class="fixed" border="1" style="border-collapse:collapse;" cellpadding="2px"
...
//        document.getElementById("pcr_officename").innerHTML = data.zilla_name;
        ...
        document.getElementById("dm_pcr_startdate").innerHTML = start_date[2] + "-" + start_date[0] + "-" + start_date[1];
        ...
        if (end_date != '') {
            ...
            document.getElementById("dm_pcr_enddate").innerHTML = "&nbsp; হতে &nbsp; " + end_date[2] + "-" + end_date[1] + "-" + end_date[0];
        } else {
        ...
        var myTable = document.getElementById("complain_info_dm");
...
//           alert(JSON.stringify(element));
            ...
            if (zillaname != element['zillaname']) {
                $('#complain_info_dm').append(
                        '<tr>' +
                                '<td colspan="10" >' + element['zillaname'] + '</td>' +
                                '</tr>' +
                                '<tr>' +
