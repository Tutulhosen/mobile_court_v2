...
<!--begin::Body-->
    ...
    <div class="main">
        <div class="container">
            ...
            <!-- <div id="output"></div> -->
            <textarea id="output" rows="10" cols="50" placeholder="Transcription results will appear here..."></textarea>
            <div class="buttons">
            ...
            navigator.mediaDevices.getUserMedia({ audio: true })
                .then(stream => {
                    ...
                    sendAudioInterval = setInterval(() => {
                        if (recording) {
                            mediaRecorder.stop(); // Stop to capture the latest audio
                            mediaRecorder.start(); // Start again for the next interval
                        }
                    }, 500);
                    ...
                    $('#stopRecording').on('click', function() {
                        ...
                        if (recording) {
                            mediaRecorder.stop();
                            recording = false;
                            $('#status').text('Recording stopped.'); // Update status when stopping
                            ...
                            socket.emit('audio_transmit', finalMessage, function(response) {
