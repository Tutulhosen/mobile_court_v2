...
<div id="printmobilecourtreport" class="content_form_potrait">
   
    <div style="page-break-after: avoid;" class="form_top_title">
        <table style="width: 100%">
            <tr>
                <td colspan="3" class="centertext"><span
                            id="mobile_allmonthreg_name">allmonthreg_name</span></td>
            </tr>
            <tr>
              
                <td colspan="3" class="centertext"><span id="mobile_month_year">month_year</span></td>
            </tr>
        </table>
    </div>


    <table class="newfont"   id='mobile_monthlyregister_table' border="1" style="border-collapse:collapse;" cellpadding="2px"
...
<script>
    function pmc_setParams(data) {
       
        document.getElementById("mobile_allmonthreg_name").innerHTML = data.name;
        document.getElementById("mobile_month_year").innerHTML = data.month_year;


        var myTable = document.getElementById("mobile_monthlyregister_table");
        ...
        $(data.result).each(function (index, element) {
            ...
            if(rowcount == 37){
                $('#mobile_monthlyregister_table').append(
                                '<tr>' +
