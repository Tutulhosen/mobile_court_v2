...
<div id="printappealcasereport" class="content_form_potrait">
 
    <div style="page-break-after: avoid;"  class="form_top_title">
        <table style="width: 100%">
            <tr>
                <td colspan="3" class="centertext"><span id="appeal_allmonthreg_name">allmonthreg_name</span></td>
            </tr>
            <tr>
               
                <td colspan="3" class="centertext"><span id="appeal_month_year">month_year</span></td>
            </tr>
        </table>
    </div>


    <table class="newfont"  id='appeal_monthlyregister_table' border="border: 1px dashed;" style="border-collapse:collapse;" cellpadding="2px"
...
<script>
    function pac_setParams(data) {

        document.getElementById("appeal_allmonthreg_name").innerHTML = data.name;
        document.getElementById("appeal_month_year").innerHTML = data.month_year;


        var myTable = document.getElementById("appeal_monthlyregister_table");
...
//           alert(JSON.stringify(element));
            ...
            if(rowcount == 38){
                ...
                $('#appeal_monthlyregister_table').append(
                                '<tr>' +
