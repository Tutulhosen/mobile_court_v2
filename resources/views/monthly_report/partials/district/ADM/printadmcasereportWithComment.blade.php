...
<div id="printadmcasereportWithComment" class="content_form_potrait">
  
    <div class="form_top_title">
        <table style="width: 100%">
            <tr>
                <td colspan="3" class="centertext"><span id="cmt_adm_allmonthreg_name">allmonthreg_name</span></td>
            </tr>
            <tr>
                <td colspan="3" class="centertext"><span id="cmt_adm_month_year">month_year</span></td>
            </tr>
        </table>
    </div>


    <table class="newfont" id='cmt_adm_monthlyregister_table' border="1" style="border-collapse:collapse;" cellpadding="2px"
...
<script>
    function padmc_setParamsWithComment(data) {

        document.getElementById("cmt_adm_allmonthreg_name").innerHTML = data.name;
        document.getElementById("cmt_adm_month_year").innerHTML = data.month_year;


        var myTable = document.getElementById("cmt_adm_monthlyregister_table");
        ...
        $(data.result).each(function (index, element) {
            ...
            if(rowcount == 38)
            {
                $('#cmt_adm_monthlyregister_table').append(
                                '<tr>' +
