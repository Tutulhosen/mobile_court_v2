...
<div id="printemcasereport" class="content_form_potrait">

    <div style="page-break-after: avoid;" class="form_top_title">
        <table style="width: 100%">
            <tr>
                <td colspan="3" class="centertext"><span id="em_allmonthreg_name">allmonthreg_name</span></td>
            </tr>
            <tr>
                <td colspan="3" class="centertext"><span id="em_month_year">month_year</span></td>
            </tr>
        </table>
    </div>


    <table class="newfont"  id='em_monthlyregister_table' border="1" style="border-collapse:collapse;" cellpadding="2px"
...
<script>
    function pemc_setParams(data) {

        document.getElementById("em_allmonthreg_name").innerHTML = data.name;
        document.getElementById("em_month_year").innerHTML = data.month_year;
...
//        document.getElementById("allmonthreg_mag_name").innerHTML = data.mag_name? data.mag_name : "" ;
        ...
        var myTable = document.getElementById("em_monthlyregister_table");
        ...
        $(data.result).each(function (index, element) {
            ...
            if(rowcount == 38 )
            {
                $('#em_monthlyregister_table').append(
                        '<tr>' +
