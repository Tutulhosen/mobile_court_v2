...
<form method="post" autocomplete="off">
    ...
    <input type="hidden" id="report_type_id" name="report_type_id" value="5"/>

    <div class="card panel-default">
        <div class="card-header smx">
            <h4 class="card-title">
                জেলা ম্যাজিস্ট্রেটগণ কর্তৃক এক্সিকিউটিভ ম্যাজিস্ট্রেটের আদালত পরিদর্শন
            </h4>
        </div>
            ...
            <div class="col-md-12">
                ...
                <div id="reportdiv" style="display: none;margin-top:40px">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label">পরিদর্শন প্রমাপ</label>
                                <input type="text" id="visit_promap" name="visit_promap" class="input form-control" readonly="readonly">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label">পরিদর্শন সংখ্যা</label>
                                <input type="number" id="visit_count" name="visit_count" class="input form-control">
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
