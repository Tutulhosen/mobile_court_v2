...
<div id="printcountryothersreport" class="content_form_potrait">
     
    <div class="form_top_title">
        <table style="width: 100%">
            <tr>
                <td colspan="3" class="centertext"><span id="report_name">Report name</span></td>
            </tr>
    ...
    <table id='countryOthersReportTable' border="1" style="border-collapse:collapse;" cellpadding="2px"
        ...
        <tr>
            ...
            <td class="centertext" style="width: 9%">নিষ্পন্ন মামলার সংখ্যা</td>
