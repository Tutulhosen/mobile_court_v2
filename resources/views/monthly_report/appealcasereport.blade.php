...
<input type="hidden" id="report_type_id" name="report_type_id" value="2"/>

<div class="card panel-default">
    <div class="card-header smx">
        <h4 class="card-title">
            মোবাইল কোর্টের আইনের আওতায় দায়েরকৃত আপিল মামলার বিবরণ
        </h4>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div id="reportdiv" style="display: none;margin-top:40px">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label class="control-label">অনিষ্পন্ন মামলা সংখ্যা</label>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        ...
                        form-control">
                            <?php // echo $this->tag->numericField(array("case_above3year" ,'class' => "input
                            //form-control"))
                            ?>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <?php //echo $this->tag->textArea(array("comment2", "cols" => 50, "rows" =>4 ,'class' =>
                            //"input form-control")) ?>
...
{{-- javascript_include("js/report/common.js") --}}
